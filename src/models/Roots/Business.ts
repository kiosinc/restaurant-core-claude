...
// FirebaseAdapter
    ...
    static create(user: User, type: BusinessType, device: string) {
        ...
        let newBusiness = new Business(device,
            uid,
            type,
            profile,
            { [uid] : Role.owner })
        ...
        return newBusiness.set()
            ...
            .then(() => {
                ...
                batch.set(ConnectedAccounts.docRef(newBusiness.Id).withConverter(ConnectedAccounts.firestoreConverter), newConnectedAccounts);
